    ...
    <div>
        ...
        <div class="posManaMain">
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-tag size="small" type="success" v-if="scope.row.enabled">opened</el-tag>
                        <el-tag size="small" type="danger" v-else>not opened</el-tag>
                    </template>
                </el-table-column>
            ...
            <el-button @click="deleteMany" type="danger" size="small" style="margin-top: 8px"
                       :disabled="multipleSelection.length==0">batch delete
            </el-button>
        </div>
        <el-dialog
    ...
    export default {
        ...
        methods: {
            ...
            handleDelete(index, data) {
                this.$confirm('This operation will delete【' + data.name + '】position, do you still continue?', 'Warning', {
                    confirmButtonText: 'confirm',
                    cancelButtonText: 'cancel',
                    type: 'warning'
                }).then(() => {
