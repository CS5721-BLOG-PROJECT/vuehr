    ...
    <div>
        <div>
            <el-table :data="emps" border stripe size="mini">
                ...
                <el-table-column prop="workID" label="ID" width="120" align="left"></el-table-column>
                ...
                <el-table-column prop="department.name" label="Department" width="120" align="left"></el-table-column>
                        ...
                        <el-tooltip placement="right" v-if="scope.row.salary">
                            <div slot="content">
                                <table>
                                    ...
                                    <tr>
                                        <td>Housing fund ratio</td>
                                        <td>{{scope.row.salary.accumulationFundPer}}</td>
                                    </tr>
                                    <tr>
                                        <td>Housing fund base</td>
                ...
                <el-table-column label="Operation" align="center">
                    <template slot-scope="scope">
                        <el-popover
                                placement="left"
                                title="edit salary model"
                                @show="showPop(scope.row.salary)"
                                @hide="hidePop(scope.row)"
                                width="200"
                                trigger="click">
                            <div>
                                <el-select v-model="currentSalary" placeholder="please select" size="mini">
                                    <el-option
                            ...
                            <el-button slot="reference" type="danger">Edit salary model</el-button>
                        </el-popover>
                    </template>
                </el-table-column>
            </el-table>
